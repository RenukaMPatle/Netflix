...
netflix_data = pd.read_csv("C:/Users/piyus/Downloads/netflix_content_2023.csv")
...
# # How viewership varies based on release dates to identify any trends over time?
...
# # What contributes to high viewership?
...
# # Check whether Netflix has a preference for releasing content on specific weekdays and patterns:
...
# # Explore specific high-impact dates
